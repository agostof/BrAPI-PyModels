...
class GermplasmAttributeMethod(BaseModel):
    ...
    description: Optional[str] = Field(
        None,
        description='Method description\n<br/>MIAPPE V1.1 (DM-90) Method description - Textual description of the method, which may extend a method defined in an external reference with specific parameters, e.g. growt\
h stage, inoculation precise organ (leaf number)',
        example='A measuring tape was used',
    )
    externalReferences: Optional[List[CrossExternalReferences]] = Field(
        None,
    ...
    ontologyReference: Optional[GermplasmAttributeMethodOntologyReference] = None
    
class GermplasmAttributeTrait(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(
        None,
        description='A free space containing any additional information related to a particular object. A data source may provide any JSON object, unrestricted by the BrAPI specification.',
    )
    ...
    attributePUI: Optional[str] = Field(
        None,
        description='The Permanent Unique Identifier of a Trait Attribute, usually in the form of a URI\n<br/>A trait can be decomposed as "Trait" = "Entity" + "Attribute", the attribute is the observed feature (or ch\
aracteristic) of the entity e.g., for "grain colour", attribute = "colour"',
    ...
    entityPUI: Optional[str] = Field(
        None,
        description='The Permanent Unique Identifier of a Trait Entity, usually in the form of a URI\n<br/>A Trait can be decomposed as "Trait" = "Entity" + "Attribute", the Entity is the part of the plant that the tr\
ait refers to e.g., for "grain colour", entity = "grain" ',
    ...
    traitClass: Optional[str] = Field(
        None,
        description='A classification to describe the type of trait and the context it should be considered in.\n<br/> examples- "morphological", "phenological", "agronomical", "physiological", "abiotic stress", "biot\
ic stress", "biochemical", "quality traits", "fertility", etc.',
...
class GermplasmAttributeMethodOntologyReference(BaseModel):
    documentationLinks: Optional[
        List[GermplasmAttributeMethodOntologyReferenceDocumentationLinks]
...
class CrossExternalReferences(BaseModel):
...
class GermplasmAttributeSearchRequest(BaseModel):
    attributeCategories: Optional[List[str]] = Field(
        None,
    ...
    attributePUIs: Optional[List[str]] = Field(
        None,
...
class BiologicalStatusOfAccessionCode2(Enum):
    field_100 = '100'
    field_110 = '110'
    field_120 = '120'
    field_130 = '130'
...
class GermplasmSearchRequest(BaseModel):
    ...
    binomialNames: Optional[List[str]] = Field(
        None,
    ...
    familyCodes: Optional[List[str]] = Field(
        None,
    ...
    instituteCodes: Optional[List[str]] = Field(
        None,
...
class PedigreeSearchRequest(BaseModel):
    accessionNumbers: Optional[List[str]] = Field(
        None,
        description='A collection of unique identifiers for materials or germplasm within a genebank\n\nMCPD (v2.1) (ACCENUMB) 2. This is the unique identifier for accessions within a genebank, and is assigned when a sample is entered into the genebank collection (e.g. "PI 113869").',
        example=['A0000003', 'A0000477'],
    ...
    includeFullTree: Optional[bool] = Field(
        None,
    ...
    pedigreeDepth: Optional[int] = Field(
        None,
    ...
    progenyDepth: Optional[int] = Field(
        None,
...
class CrossCrossAttributes(BaseModel):
...
class CrossPollinationEvents(BaseModel):
    pollinationNumber: Optional[str] = Field(
        None, description='The unique identifier for this pollination event'
    )
    pollinationSuccessful: Optional[bool] = Field(
        None, description='True if the pollination was successful'
    )
...
class GermplasmDonors(BaseModel):
...
class GermplasmGermplasmOrigin(BaseModel):
...
class GermplasmStorageTypes(BaseModel):
...
class GermplasmSynonyms(BaseModel):
...
class GermplasmTaxonIds(BaseModel):
    sourceName: str = Field(
        ...,
        description='The human readable name of the taxonomy provider',
        example='NCBI',
...
class GermplasmAttributeMethodOntologyReferenceDocumentationLinks(BaseModel):
    URL: Optional[AnyUrl] = Field(None, example='http://purl.obolibrary.org/obo/ro.owl')
    type: Optional[Type] = Field(None, example='OBO')


class GermplasmAttributeScaleValidValuesCategories(BaseModel):
...
class GermplasmAttributeScaleValidValues(BaseModel):
    categories: Optional[List[GermplasmAttributeScaleValidValuesCategories]] = Field(
        None,
...
class PedigreeNodeParents(BaseModel):
    ...
    germplasmName: Optional[str] = Field(
        None, description='A human readable name for a germplasm', example='A0000592'
    )
...
class PedigreeNodeDEPParents(BaseModel):
    germplasmDbId: Optional[str] = Field(
        None,
    ...
    parentType: Optional[ParentTypeDEP] = None


class PedigreeNodeDEPSiblings(BaseModel):
    germplasmDbId: Optional[str] = Field(
...
class ProgenyNodeDEPProgeny(BaseModel):
    germplasmDbId: str = Field(
        ...,
    ...
    parentType: ParentTypeDEP


class SeedLotContentMixture(BaseModel):
    ...
    mixturePercentage: Optional[int] = Field(
        None,
...
class BreedingMethodListResponseResult(BaseModel):
    data: List[BreedingMethod] = Field(
        ...,
        description='The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.',
    )
...
class TransactionDirection1(Enum):
    TO = 'TO'
    FROM = 'FROM'
    BOTH = 'BOTH'


class TransactionDirection2(Enum):
    TO = 'TO'
    FROM = 'FROM'
    BOTH = 'BOTH'
...
class Cross(BaseModel):
    ...
    crossAttributes: Optional[List[CrossCrossAttributes]] = Field(
        None, description='Set of custom attributes associated with a cross'
    )
    crossDbId: str = Field(
        ..., description='the unique identifier for a cross', example='d105fd6f'
    )
    crossName: Optional[str] = Field(
        None,
    ...
    parent1: Optional[CrossParent1] = None
    parent2: Optional[CrossParent1] = None
    ...
    pollinationEvents: Optional[List[CrossPollinationEvents]] = Field(
        None, description='The list of pollination events that occurred for this cross'
    )
    pollinationTimeStamp: Optional[datetime] = Field(
        None,
...
class CrossingProject(BaseModel):
    ...
    potentialParents: Optional[List[CrossParent1]] = Field(
        None,
...
class Germplasm(BaseModel):
    ...
    donors: Optional[List[GermplasmDonors]] = Field(
    ...
    germplasmOrigin: Optional[List[GermplasmGermplasmOrigin]] = Field(
        None,
    ...
    storageTypes: Optional[List[GermplasmStorageTypes]] = Field(
        None,
    ...
    synonyms: Optional[List[GermplasmSynonyms]] = Field(
        None,
    ...
    taxonIds: Optional[List[GermplasmTaxonIds]] = Field(
        None,
...
class GermplasmAttribute(BaseModel):
    ...
    method: GermplasmAttributeMethod
    ontologyReference: Optional[GermplasmAttributeMethodOntologyReference] = None
    scale: GermplasmAttributeScale
    ...
    trait: GermplasmAttributeTrait

class GermplasmAttributeScale(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(
        None,
        description='A free space containing any additional information related to a particular object. A data source may provide any JSON object, unrestricted by the BrAPI specification.',
    )
    dataType: Optional[DataType] = Field(
        None,
        description='<p>Class of the scale, entries can be</p>\n<p>"Code" -  This scale class is exceptionally used to express complex traits. Code is a nominal scale that combines the expressions of the different tra\
its composing the complex trait. For example a severity trait might be expressed by a 2 digit and 2 character code. The first 2 digits are the percentage of the plant covered by a fungus and the 2 characters refer to \
the delay in development, e.g. "75VD" means "75 %" of the plant is infected and the plant is very delayed.</p>\n<p>"Date" - The date class is for events expressed in a time format, See ISO 8601</p>\n<p>"Duration" - Th\
e Duration class is for time elapsed between two events expressed in a time format, e.g. days, hours, months</p>\n<p>"Nominal" - Categorical scale that can take one of a limited and fixed number of categories. There i\
s no intrinsic ordering to the categories</p>\n<p>"Numerical" - Numerical scales express the trait with real numbers. The numerical scale defines the unit e.g. centimeter, ton per hectare, branches</p>\n<p>"Ordinal" -\
 Ordinal scales are scales composed of ordered categories</p>\n<p>"Text" - A free text is used to express the trait.</p>',
        example='Numerical',
    )
...
\napplies when `dataType` is Numeric, but could also be included for other dataTypes when applicable.',
    ...
    validValues: Optional[GermplasmAttributeScaleValidValues] = None
...
class GermplasmMCPD(BaseModel):
    ...
    breedingInstitutes: Optional[List[GermplasmMCPDBreedingInstitutes]] = Field(
        None,
...
class GermplasmNewRequest(BaseModel):
    ...
    biologicalStatusOfAccessionCode: Optional[BiologicalStatusOfAccessionCode2] = Field(
        None,
        description='MCPD (v2.1) (SAMPSTAT) 19. The coding scheme proposed can be used at 3 different levels of detail: either by using the general codes such as 100, 200, 300, 400, or by using the more specific codes such as 110, 120, etc. \n\n100) Wild \n110) Natural \n120) Semi-natural/wild \n130) Semi-natural/sown \n200) Weedy \n300) Traditional cultivar/landrace \n400) Breeding/research material \n410) Breeders line \n411) Synthetic population \n412) Hybrid \n413) Founder stock/base population \n414) Inbred line (parent of hybrid cultivar) \n415) Segregating population \n416) Clonal selection \n420) Genetic stock \n421) Mutant (e.g. induced/insertion mutants, tilling populations) \n422) Cytogenetic stocks (e.g. chromosome addition/substitution, aneuploids,  amphiploids) \n423) Other genetic stocks (e.g. mapping populations) \n500) Advanced or improved cultivar (conventional breeding methods) \n600) GMO (by genetic engineering) \n999) Other (Elaborate in REMARKS field)',
        example='420',
    )
...
class PedigreeNode(BaseModel):
    ...
    germplasmName: str = Field(
        ..., description='A human readable name for a germplasm', example='A0021004'
    )
    germplasmPUI: Optional[str] = Field(
        None,
        description='The Permanent Unique Identifier which represents a germplasm\n\nMIAPPE V1.1 (DM-41) Biological material ID - Code used to identify the biological material in the data file. Should be unique within the Investigation. Can correspond to experimental plant ID, seed lot ID, etc This material identification is different from a BiosampleID which corresponds to Observation Unit or Samples sections below.\n\nMIAPPE V1.1 (DM-51) Material source DOI - Digital Object Identifier (DOI) of the material source\n\nMCPD (v2.1) (PUID) 0. Any persistent, unique identifier assigned to the accession so it can be unambiguously referenced at the global level and the information associated with it harvested through automated means. Report one PUID for each accession. The Secretariat of the International Treaty on Plant Genetic Resources for Food and Agriculture (PGRFA) is facilitating the assignment of a persistent unique identifier (PUID), in the form of a DOI, to PGRFA at the accession level. Genebanks not applying a true PUID to their accessions should use, and request recipients to use, the concatenation of INSTCODE, ACCENUMB, and GENUS as a globally unique identifier similar in most respects to the PUID whenever they exchange information on accessions with third parties.',
...
class PedigreeNodeDEP(BaseModel):
    crossingProjectDbId: Optional[str] = Field(
        None,
        description='The crossing project used to generate this germplasm',
        example='625e745a',
    ...
    parents: Optional[List[PedigreeNodeDEPParents]] = Field(
        None,
    ...
    siblings: Optional[List[PedigreeNodeDEPSiblings]] = Field(
        None,
...
class PlannedCross(BaseModel):
    ...
    crossType: Optional[CrossType2] = Field(
        None, description='the type of cross', example='BIPARENTAL'
    )
    crossingProjectDbId: Optional[str] = Field(
        None,
    ...
    parent1: Optional[CrossParent1] = None
    parent2: Optional[CrossParent1] = None
    plannedCrossDbId: str = Field(
        ..., description='the unique identifier for a planned cross', example='c8905568'
    )
    plannedCrossName: Optional[str] = Field(
        None,
        description='the human readable name for a planned cross',
...
class PlannedCrossNewRequest(BaseModel):
    ...
    crossType: Optional[CrossType3] = Field(
        None, description='the type of cross', example='BIPARENTAL'
    )
    crossingProjectDbId: Optional[str] = Field(
        None,
...
class ProgenyNodeDEP(BaseModel):
    germplasmDbId: str = Field(
        ...,
        description='The ID which uniquely identifies a germplasm',
        example='01b974dc',
    ...
    progeny: List[ProgenyNodeDEPProgeny] = Field(
        ...,
...
class SeedLot(BaseModel):
    ...
    contentMixture: Optional[List[SeedLotContentMixture]] = Field(
        None,
    ...
    locationName: Optional[str] = Field(
        None, description='A human readable name for a location', example='Location 1'
    )
    programDbId: Optional[str] = Field(
        None,
...
class SeedLotTransactionNewRequest(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(
        None,
        description='A free space containing any additional information related to a particular object. A data source may provide any JSON object, unrestricted by the BrAPI specification.',
    )
...
class GermplasmPedigreeResponse(BaseModel):
    field_context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: PedigreeNodeDEP


class GermplasmProgenyResponse(BaseModel):
    field_context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
    result: ProgenyNodeDEP
...
class GermplasmAttributeListResponseResult(BaseModel):
    data: List[GermplasmAttribute] = Field(
        ...,
        description='The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.',
    )
...
class GermplasmAttributeValueListResponseResult(BaseModel):
    data: List[GermplasmAttributeValue] = Field(
        ...,
        description='The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.',
    )
...
class CrossingProjectsListResponseResult(BaseModel):
    data: List[CrossingProject] = Field(
        ...,
        description='The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.',
    )
...
class GermplasmListResponseResult(BaseModel):
    data: List[Germplasm] = Field(
        ...,
        description='The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.',
    )


class PedigreeListResponseResult(BaseModel):
    data: List[PedigreeNode] = Field(
        ...,
        description='The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.',
    )
...
class SeedLotTransactionListResponseResult(BaseModel):
    data: List[SeedLotTransaction] = Field(
        ...,
        description='The `data` array is part of the BrAPI standard List Response JSON container. `data` will always contain the primary list of objects being returned by a BrAPI endpoint. `data` is also the only array impacted by the `metadata.pagination` details. When the pagination parameters change, the `data` array will reflect those changes in the JSON response.',
    )
...
class CrossesPutRequest(BaseModel):
    __root__: Optional[Dict[str, CrossNewRequest]] = None


class PedigreePutRequest(BaseModel):
    __root__: Optional[Dict[str, PedigreeNode]] = None


class PlannedcrossesPutRequest(BaseModel):
    __root__: Optional[Dict[str, PlannedCrossNewRequest]] = None
...
class PedigreeListResponse(BaseModel):
    field_context: Optional[Context] = Field(None, alias='@context')
    metadata: Metadata
