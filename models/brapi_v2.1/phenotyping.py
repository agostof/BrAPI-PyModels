...
class Trait(BaseModel):
    ...
    attributePUI: Optional[str] = Field(
        None,
        description='The Permanent Unique Identifier of a Trait Attribute, usually in the form of a URI\n<br/>A trait can be decomposed as "Trait" = "Entity" + "Attribute", the attribute is the observed fea\
ture (or characteristic) of the entity e.g., for "grain colour", attribute = "colour"',
    ...
    entityPUI: Optional[str] = Field(
        None,
        description='The Permanent Unique Identifier of a Trait Entity, usually in the form of a URI\n<br/>A Trait can be decomposed as "Trait" = "Entity" + "Attribute", the Entity is the part of the plant \
that the trait refers to e.g., for "grain colour", entity = "grain" ',
    ...
    traitClass: Optional[str] = Field(
        None,
        description='A classification to describe the type of trait and the context it should be considered in.\n<br/> examples- "morphological", "phenological", "agronomical", "physiological", "abiotic str\
ess", "biotic stress", "biochemical", "quality traits", "fertility", etc.',
        example='phenological',
    )
    traitDbId: str = Field(
        ..., description='The ID which uniquely identifies a trait', example='9b2e34f5'
    )
...
class Scale(BaseModel):
    ...
    dataType: Optional[DataType] = Field(
        None,
        description='<p>Class of the scale, entries can be</p>\n<p>"Code" -  This scale class is exceptionally used to express complex traits. Code is a nominal scale that combines the expressions of the di\
fferent traits composing the complex trait. For example a severity trait might be expressed by a 2 digit and 2 character code. The first 2 digits are the percentage of the plant covered by a fungus and the \
2 characters refer to the delay in development, e.g. "75VD" means "75 %" of the plant is infected and the plant is very delayed.</p>\n<p>"Date" - The date class is for events expressed in a time format, See\
 ISO 8601</p>\n<p>"Duration" - The Duration class is for time elapsed between two events expressed in a time format, e.g. days, hours, months</p>\n<p>"Nominal" - Categorical scale that can take one of a lim\
ited and fixed number of categories. There is no intrinsic ordering to the categories</p>\n<p>"Numerical" - Numerical scales express the trait with real numbers. The numerical scale defines the unit e.g. ce\
ntimeter, ton per hectare, branches</p>\n<p>"Ordinal" - Ordinal scales are scales composed of ordered categories</p>\n<p>"Text" - A free text is used to express the trait.</p>',
        example='Numerical',
    )
...
class ObservationVariableTrait(BaseModel):
    ...
    alternativeAbbreviations: Optional[List[str]] = Field(
        None,
        description='A list of shortened, human readable, names for a Trait. These abbreviations are acceptable alternatives to the mainAbbreviation and do not need to follow any formatting convent\
ion.',
        example=['H', 'PH', 'H1'],
    )
    attribute: Optional[str] = Field(
        None,
        description='A trait can be decomposed as "Trait" = "Entity" + "Attribute", the attribute is the observed feature (or characteristic) of the entity e.g., for "grain colour", attribute = "co\
lour"',
        example='height',
    )
    attributePUI: Optional[str] = Field(
        None,
        description='The Permanent Unique Identifier of a Trait Attribute, usually in the form of a URI\n<br/>A trait can be decomposed as "Trait" = "Entity" + "Attribute", the attribute is the obs\
erved feature (or characteristic) of the entity e.g., for "grain colour", attribute = "colour"',
        example='http://my-traits.com/trait/PO:00012345',
    )
    entity: Optional[str] = Field(
        None,
    ...
    entityPUI: Optional[str] = Field(
        None,
        description='The Permanent Unique Identifier of a Trait Entity, usually in the form of a URI\n<br/>A Trait can be decomposed as "Trait" = "Entity" + "Attribute", the Entity is the part of t\
he plant that the trait refers to e.g., for "grain colour", entity = "grain" ',
        example='http://my-traits.com/trait/PATO:00098765',
    )
    externalReferences: Optional[List[ExternalReferencesInner]] = Field(
        None,
    ...
    traitClass: Optional[str] = Field(
        None,
        description='A classification to describe the type of trait and the context it should be considered in.\n<br/> examples- "morphological", "phenological", "agronomical", "physiological", "ab\
iotic stress", "biotic stress", "biochemical", "quality traits", "fertility", etc.',
        example='phenological',
    )
...
class MethodOntologyReference(BaseModel):
    documentationLinks: Optional[
        List[MethodOntologyReferenceDocumentationLinks]
...
class ObservationVariableMethod(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(
        None,
        description='A free space containing any additional information related to a particular object. A data source may provide any JSON object, unrestricted by the BrAPI specification.',
    )
    ...
    description: Optional[str] = Field(
        None,
        description='Method description\n<br/>MIAPPE V1.1 (DM-90) Method description - Textual description of the method, which may extend a method defined in an external reference with spec\
ific parameters, e.g. growth stage, inoculation precise organ (leaf number)',
...
class ObservationVariableScale(BaseModel):
    additionalInfo: Optional[Dict[str, str]] = Field(
        None,
        description='A free space containing any additional information related to a particular object. A data source may provide any JSON object, unrestricted by the BrAPI specification.',
    )
    dataType: Optional[DataType] = Field(
        None,
        description='<p>Class of the scale, entries can be</p>\n<p>"Code" -  This scale class is exceptionally used to express complex traits. Code is a nominal scale that combines the expre\
ssions of the different traits composing the complex trait. For example a severity trait might be expressed by a 2 digit and 2 character code. The first 2 digits are the percentage of the pl\
ant covered by a fungus and the 2 characters refer to the delay in development, e.g. "75VD" means "75 %" of the plant is infected and the plant is very delayed.</p>\n<p>"Date" - The date cla\
ss is for events expressed in a time format, See ISO 8601</p>\n<p>"Duration" - The Duration class is for time elapsed between two events expressed in a time format, e.g. days, hours, months<\
/p>\n<p>"Nominal" - Categorical scale that can take one of a limited and fixed number of categories. There is no intrinsic ordering to the categories</p>\n<p>"Numerical" - Numerical scales e\
xpress the trait with real numbers. The numerical scale defines the unit e.g. centimeter, ton per hectare, branches</p>\n<p>"Ordinal" - Ordinal scales are scales composed of ordered categori\
es</p>\n<p>"Text" - A free text is used to express the trait.</p>',
        example='Numerical',
    )
    decimalPlaces: Optional[int] = Field(
    ...
    units: Optional[str] = Field(
        None,
        description='This field can be used to describe the units used for this scale. This should be the abbreviated \nform of the units, intended to be displayed with every value using thi\
s scale. Usually this only \napplies when `dataType` is Numeric, but could also be included for other dataTypes when applicable.',
        example='m',
    )
    validValues: Optional[ObservationVariableScaleValidValues] = None

class ObservationUnitObservationUnitPosition(BaseModel):
    entryType: Optional[EntryType1] = Field(
        None,
        description='The type of entry for this observation unit. ex. "CHECK", "TEST", "FILLER"',
        example='TEST',
    )
    geoCoordinates: Optional[GeoJSON] = None
    observationLevel: Optional[ObservationUnitLevel2] = None
    observationLevelRelationships: Optional[
        List[ObservationUnitLevelRelationship1]
    ] = Field(
        None,
        description='Observation levels indicate the granularity level at which the measurements are taken. `levelName` \ndefines the level, `levelOrder` defines where that level exists in t\
he hierarchy of levels. \n`levelOrder`s lower numbers are at the top of the hierarchy (ie field > 0) and higher numbers are \nat the bottom of the hierarchy (ie plant > 6). `levelCode` is an\
 ID code for this level tag. Identify \nthis observation unit by each level of the hierarchy where it exists. \n\nFor more information on Observation Levels, please review the <a target="_bl\
ank" href="https://wiki.brapi.org/index.php/Observation_Levels">Observation Levels documentation</a>. \n\n**Standard Level Names: study, field, entry, rep, block, sub-block, plot, sub-plot, \
plant, pot, sample** ',
        example=[
    ...
    positionCoordinateXType: Optional[PositionCoordinateXType1] = Field(
        None,
        description="The type of positional coordinate used. Must be one of the following values \n\nLONGITUDE - ISO 6709 standard, WGS84 geodetic datum. See 'Location Coordinate Encoding' f\
or details \n\nLATITUDE - ISO 6709 standard, WGS84 geodetic datum. See 'Location Coordinate Encoding' for details \n\nPLANTED_ROW - The physical planted row number \n\nPLANTED_INDIVIDUAL - T\
he physical counted number, could be independant or within a planted row \n\nGRID_ROW - The row index number of a square grid overlay \n\nGRID_COL - The column index number of a square grid \
overlay \n\nMEASURED_ROW - The distance in meters from a defined 0-th row \n\nMEASURED_COL - The distance in meters from a defined 0-th column ",
    ...
    positionCoordinateYType: Optional[PositionCoordinateYType1] = Field(
        None,
        description="The type of positional coordinate used. Must be one of the following values \n\nLONGITUDE - ISO 6709 standard, WGS84 geodetic datum. See 'Location Coordinate Encoding' f\
or details \n\nLATITUDE - ISO 6709 standard, WGS84 geodetic datum. See 'Location Coordinate Encoding' for details \n\nPLANTED_ROW - The physical planted row number  \n\nPLANTED_INDIVIDUAL - \
The physical counted number, could be independant or within a planted row \n\nGRID_ROW - The row index number of a square grid overlay \n\nGRID_COL - The column index number of a square grid\
 overlay \n\nMEASURED_ROW - The distance in meters from a defined 0-th row \n\nMEASURED_COL - The distance in meters from a defined 0-th column ",
        example='GRID_ROW',
    )
...
class ObservationUnitLevelRelationship1(BaseModel):
    levelCode: Optional[str] = Field(
        None,
        description="An ID code or number to represent a real thing that may or may not be an an observation unit.\n<br/>For example, if the 'levelName' is 'plot', then the 'levelCode' would be the plot number or plot barcode. If this plot is also considered an ObservationUnit, then the appropriate observationUnitDbId should also be recorded.\n<br/>If the 'levelName' is 'field', then the 'levelCode' might be something like '3' or 'F3' to indicate the third field at a research station. ",
        example='Plot_123',
...
class ObservationUnitLevel1(BaseModel):
    levelCode: Optional[str] = Field(
        None,
        description="An ID code or number to represent a real thing that may or may not be an an observation unit.\n<br/>For example, if the 'levelName' is 'plot', then the 'levelCode' would be the plot number or plot barcode. If this plot is also considered an ObservationUnit, then the appropriate observationUnitDbId should also be recorded.\n<br/>If the 'levelName' is 'field', then the 'levelCode' might be something like '3' or 'F3' to indicate the third field at a research station. ",
        example='Plot_123',
...
class SearchObservationsBody(BaseModel):
    ...
    observationLevels: Optional[List[ObservationUnitLevel1]] = Field(
        None,
...
class ObservationUnitLevel2(BaseModel):
    levelCode: Optional[str] = Field(
        None,
        description="An ID code or number to represent a real thing that may or may not be an an observation unit.\n<br/>For example, if the 'levelName' is 'plot', then the 'levelCode' would be the plot number or plot barcode. If this plot is also considered an ObservationUnit, then the appropriate observationUnitDbId should also be recorded.\n<br/>If the 'levelName' is 'field', then the 'levelCode' might be something like '3' or 'F3' to indicate the third field at a research station. ",
        example='Plot_123',
...
class PositionCoordinateXType1(Enum):
    LONGITUDE = 'LONGITUDE'
    LATITUDE = 'LATITUDE'
...
class PositionCoordinateYType1(Enum):
    LONGITUDE = 'LONGITUDE'
    LATITUDE = 'LATITUDE'
    PLANTED_ROW = 'PLANTED_ROW'
    PLANTED_INDIVIDUAL = 'PLANTED_INDIVIDUAL'
